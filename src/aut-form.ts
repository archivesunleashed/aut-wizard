...
class AutForm {
    ...
    document.addEventListener("DOMContentLoaded", function(doc) {
      ...
      document.querySelector('body').addEventListener('click', function(event) {
          ...
          switch (elem.id) {
            ...
            case 'language':{
              var langid = (document.getElementById('languageinput') as HTMLSelectElement);
            ...
            case 'date': {
              var dateval = "";
              var date = (document.getElementById('dateinput') as HTMLInputElement).value;
              if (date.length == 4) {
                dateval = 'YYYY';
              }
  ...
  addFilter (name:string, value:string = "") {
    ...
    if (value == "") {
      value = (document.getElementById(name+'input') as HTMLInputElement).value;
    }
  ...
  createScript() {
    ...
    let inc = (document.getElementsByClassName('inc') as HTMLCollectionOf<HTMLInputElement>);
    let output = document.getElementById('outputType');
    let path = (document.getElementById('collectionPath') as HTMLInputElement).value;
    let filters = document.getElementById('filters').childNodes;
    let screen_output = (document.getElementById('take_output') as HTMLInputElement).value;
    ...
    for (var i = 0; i < filters.length; i++) {
      ...
      if ((filters[i] as HTMLElement).className == "domainFilter"){
        if (domain) {
        } else {
        domain = true;
      ...
      if ((filters[i] as HTMLElement).className == "urlFilter"){
        if (urlInput) {
        }
        else {
          urlInput = true;
      ...
      if ((filters[i] as HTMLElement).className == "keywordFilter"){
        if (keyword) {
        }
        else {
          keyword = true;
      ...
      if ((filters[i] as HTMLElement).className == "languageFilter"){
        if (language) {
        }
        else {
          language = true;
      ...
      if ((filters[i] as HTMLElement).className == "dateFilter"){
        if (date) {
        }
        else {
          date = true;
